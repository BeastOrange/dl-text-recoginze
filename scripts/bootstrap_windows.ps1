...
Write-Host "  uv run python scripts/run_dltr.py data validate"
Write-Host "  uv run python scripts/run_dltr.py data stats"
Write-Host "  uv run python scripts/run_dltr.py demo"
Write-Host "  uv run python scripts/run_dltr.py evaluate end2end"
