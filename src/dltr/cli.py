...
def build_parser() -> argparse.ArgumentParser:
    ...
    train_detector.add_argument("--resume-from")
    ...
    train_recognizer.add_argument("--resume-from")
    ...
    train_end2end.add_argument("--resume-from")
    ...
    eval_end2end.add_argument("--sweep", action="store_true")
    eval_end2end.add_argument("--sweep-detector-thresholds", nargs="+", type=float)
    eval_end2end.add_argument("--sweep-min-areas", nargs="+", type=float)
